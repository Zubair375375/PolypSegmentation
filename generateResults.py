...
if __name__ == "__main__":
    ...
    path = "C:\Users\win10\Desktop\Polyp-Segmentation-using-Majority-Voiting-FYP-main"
    batch_size = 8
...
#   Load your own model here i.e modelFile.h5
    with CustomObjectScope({'iou': iou}):
        model = tf.keras.models.load_model("C:\Users\win10\Desktop\Polyp-Segmentation-using-Majority-Voiting-FYP-main\model.h5")
    ...
    for i, (x, y) in tqdm(enumerate(zip(test_x, test_y)), total=len(test_x)-600):
        ...
        cv2.imwrite(f"C:\Users\win10\Desktop\Polyp-Segmentation-using-Majority-Voiting-FYP-main\custom\{i}.png", image)